...
(defmfun1 ($simple_doc_add :doc) ((name :string) (content :string))
 "Adds documentation string <content> for item <name>. These documentation
 strings are accessible via '?' and '??'."
...
(max-doc::see-also-group '( "simple_doc_init" "simple_doc_add" "simple_doc_delete" "simple_doc_get" "simple_doc_print"))
