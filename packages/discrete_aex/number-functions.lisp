...
;; Terms are generated by: bterm(k) := bern(2*k)/(2*k*n^(2*k));
...
(defun harmonic-number-asymp-real (n)
  (let ((harm-num
         (meval `((mplus simp) $%gamma
                  ((mtimes simp) ((rat simp) 1 120) ((mexpt simp) ,n -4))
                  ((mtimes simp) ((rat simp) -1 12) ((mexpt simp) ,n -2))
                  ((mtimes simp) ((rat simp) 1 2) ((mexpt simp) ,n -1)) ((%log simp) ,n)))))
    (if ($bfloatp n)
        ($bfloat harm-num) ($float harm-num))))
